                    ...
                    <div class="owl-carousel owl-theme">
                         <div class="item item-first">
                              <figure class="item_bg">
                                   <img src="./content/choco1.jpg" alt="tablette de chocolat" item_img>
                              </figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             <h3>
                                                  <?php echo('Coucou, je vends du chocolat !');?>
                                             </h3>
                         ...
                         <div class="item item-second">
                              <figure class="item_bg">
                                   <img src="./content/choco2.jpg" alt="tablette de chocolat" item_img>
                              </figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             <h3>
                                                  <?='Coucou, je vends aussi du chocolat !' ?> 
                                             </h3>
                         ...
                         <div class="item item-third">
                              <figure class="item_bg">
                                   <img src="./content/choco3.jpg" alt="tablette de chocolat" item_img>
                              </figure>
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             <h3>
                                                  <?='Coucou, je vends aussi du chochocolat !' ?> 
                                             </h3>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="wow fadeInUp about-image" data-wow-delay="0.6s">
                              <img src="./content/choco4.jpg" class="img-responsive" alt="">
                         </div>
                    </div>
